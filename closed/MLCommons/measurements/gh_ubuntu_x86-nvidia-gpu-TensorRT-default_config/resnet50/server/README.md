...
cm pull repo gateoverflow@cm4mlops --checkout=5f72cf5bac1c05cfaddb35b524f4a1bace266966
...
cm run script \
	...
	--env.CM_DOCKER_CONTAINER_ID=e57c293cfad3 \
...
### Performance Results 
`Scheduled samples per second`: `73015.2`
