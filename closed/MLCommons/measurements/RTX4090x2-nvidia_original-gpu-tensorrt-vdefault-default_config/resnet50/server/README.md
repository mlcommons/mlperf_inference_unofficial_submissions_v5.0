...
cm pull repo gateoverflow@cm4mlops --checkout=aa5bfac317f98ff152c24b24a8d144f9681abf30
...
cm run script \
	...
	--env.CM_DOCKER_CONTAINER_ID=202cbffac3f7 \
...
### Performance Results 
`Scheduled samples per second`: `73743.9`
