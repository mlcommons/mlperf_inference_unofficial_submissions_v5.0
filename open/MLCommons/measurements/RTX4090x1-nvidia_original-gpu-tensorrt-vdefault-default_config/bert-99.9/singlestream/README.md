...
cm run script \
	--tags=app,mlperf,inference,generic,_nvidia,_bert-99.9,_tensorrt,_cuda,_valid,_r4.1-dev_default,_singlestream \
	--quiet=true \
	--env.CM_QUIET=yes \
...
### Accuracy Results 
`F1`: `90.87504`, Required accuracy for closed division `>= 90.78313`

### Performance Results 
`90th percentile latency (ns)`: `2163963.0`
