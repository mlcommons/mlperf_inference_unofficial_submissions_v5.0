...
cm pull repo gateoverflow@cm4mlops --checkout=86860484e33ebd03de3a69208a6ba32793c68228
...
cm run script \
	...
	--env.CM_DOCKER_CONTAINER_ID=0a17de7e84f8 \
...
### Performance Results 
`Scheduled samples per second`: `73744.0`
