...
cm pull repo mlcommons@mlperf-automations --checkout=d28df7ea880337a024f9c3854d3fdd14224b8e8e

cm run script \
	--tags=app,mlperf,inference,generic,_nvidia,_sdxl,_tensorrt,_cuda,_valid,_r4.1-dev_default,_server \
	--quiet=true \
	--env.CM_QUIET=yes \
...
### Performance Results 
`Scheduled samples per second`: `0.881818`
